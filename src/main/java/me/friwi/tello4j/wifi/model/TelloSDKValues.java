...
public class TelloSDKValues {
    ...
    public static final int SIMULATOR_COMMAND_PORT = 8879;

    public static final int STATE_PORT = 8890;
    public static final int STREAM_PORT = 11111;

    public static final int COMMAND_SOCKET_TIMEOUT = 200000; //20000
    public static final int COMMAND_TIMEOUT = 150000; //15000
    public static final int STATE_SOCKET_TIMEOUT = 1000;
    public static final int VIDEO_SOCKET_TIMEOUT = 100000; //1000
